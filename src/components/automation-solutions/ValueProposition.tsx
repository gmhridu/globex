    ...
    <section className="bg-white py-12" ref={ref}>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <Image
              src="/assests/industries/automation-solution/qtq80-jZTM2Q-768x513-1.jpeg"
              alt="Empowring"
              width={300}
              height={300}
          ...
          >
            ...
            <p className="text-md mb-4 font-semibold">
              ...
              at the forefront of this transformation. We Are Globex partners
              with automation solution providers to help them grow by reaching
              decision-makers who prioritize innovation. By focusing on lead
              generation, tailored sales solutions, and marketing services, we
              create opportunities for your business to succeed in a competitive
              market.
            </p>
            <div className="mt-2">
              <Button
