...
export async function POST(request: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      replyTo: email,
      subject: `Certified Distributor application — ${firstName} ${lastName}`,
      html: emailLayout({
        preheader: "A new Certified Distributor application has been received.",
        content: `
          <h2 style="margin: 0 0 16px 0; color: #111827; font-size: 20px; line-height: 1.3;">Certified Distributor Application</h2>
    ...
    console.error("Error submitting certified distributor application:", error);
    return NextResponse.json(
