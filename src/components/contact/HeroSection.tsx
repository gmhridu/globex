    ...
    <section className="relative bg-secondary pt-24 min-h-[80vh] flex items-center">
      ...
      <div className="container relative z-10 py-16 md:py-24">
        <div className="max-w-[1300px]">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white whitespace-nowrap tracking-[0.4em] leading-[2.2] uppercase">
            We’re Here to Help <br />
          </h3>
          <h1 className="text-primary text-4xl md:text-6xl  lg:text-8xl ">
            Contact Us
          </h1>
        </div>
      </div>
