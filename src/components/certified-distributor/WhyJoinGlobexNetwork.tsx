        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative z-10 overflow-hidden">
              <Image
                src="/assests/distributors/business.jpg" // Update path as needed
          ...
          >
            ...
            <p className="mb-6">
              By joining our network, you&apos;ll have the opportunity to tell us
              what you need, whether it&apos;s a specific category, brand, or product
              type, and we&apos;ll connect you with manufacturers actively looking
              for distribution partners in your region.
            </p>
            <p className="mb-6">
              ...
              manufacturers with distributors, we&apos;re here to build long-term,
              profitable partnerships that make sense for everyone involved.
            </p>
          </motion.div>
        </div>
      </div>
