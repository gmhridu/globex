  ...
  return (
    <section id="contact" className="relative py-36 overflow-hidden">
      <div className="absolute inset-0 bg-[#080b10]">
        <img
          src="https://images.unsplash.com/photo-1634638026221-4c1c4cf9f881?w=1800&h=800&fit=crop&auto=format"
          alt="Container ship on the open sea representing global export"
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          Your Next
          <br />
          <span className="text-[#e8a020]">Market.</span>
        </h2>
        <p
          className="text-sm text-muted-foreground max-w-md mx-auto mb-12"
          style={sans()}
        >
          Together. No commitment. Tell us about your product and where you want
          to go — we'll tell you honestly if we can help.
        </p>
